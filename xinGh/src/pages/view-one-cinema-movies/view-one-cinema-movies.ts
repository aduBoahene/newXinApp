...
@IonicPage()
@Component({
  selector: 'page-view-one-cinema-movies',
  templateUrl: 'view-one-cinema-movies.html',
})
export class ViewOneCinemaMoviesPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams) {
    ...
    console.log("from previous ", this.movieFromPreviousPage)
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad ViewOneCinemaMoviesPage');
